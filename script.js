...
function changebg(){ //changes background
  document.getElementById("intro").onmouseover = function(evt){
    document.body.style.background = "url('images/backgrounds/Landing.png') no-repeat center center fixed";
  ...
  document.getElementById("schedule").onmouseover = function(evt){
    document.body.style.background = "url('images/backgrounds/Sections.png') no-repeat center center fixed";
    document.body.style.backgroundSize = "110%";
  ...
  document.getElementById("team").onmouseover = function(evt){
    document.body.style.background = "url('images/backgrounds/Contact.png') no-repeat center center fixed";
    document.body.style.backgroundSize = "110%";
